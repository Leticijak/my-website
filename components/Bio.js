        ...
        <div className={styles.newstylez}>
          ...
          <div className={styles.right}>
            <p>
              ...
              using JavaScript and its frameworks ever since. Making web sites
              for individuals, local businesses and established brands.
              Technologies that I'm most proficient at are
            </p>
            <p>
              <span>Front-end</span> : Next,js, React.js, Html5 and Css3,
              Vanilla JavaScript
            </p>
            <p>
